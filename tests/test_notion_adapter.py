...
class TestNotionCaching:
    ...
    def test_init_with_cached_data_source_id(self, mock_client_class):
    ...
    @patch('notion_client.Client')
    def test_init_without_cache(self, mock_client_class):
        """测试不使用缓存的初始化"""
        mock_client = Mock()
        mock_client_class.return_value = mock_client
    ...
    @patch('vibe_todo.config.get_config')
    @patch('notion_client.Client')
    def test_lazy_data_source_retrieval(self, mock_client_class, mock_get_config):
    ...
    @patch('vibe_todo.config.get_config')
    @patch('notion_client.Client')
    def test_cache_data_source_id(self, mock_client_class, mock_get_config):
    ...
    @patch('notion_client.Client')
    def test_ensure_data_source_idempotent(self, mock_client_class):
    ...
    @patch('vibe_todo.config.get_config')
    @patch('notion_client.Client')
    def test_fallback_to_database_id(self, mock_client_class, mock_get_config):
...
class TestNotionPagination:
    ...
    @patch('notion_client.Client')
    def test_list_all_with_pagination(self, mock_client_class):
        """测试分页查询所有任务"""
        mock_client = Mock()
        mock_client_class.return_value = mock_client
